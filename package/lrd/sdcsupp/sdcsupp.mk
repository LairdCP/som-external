...
HOSTAPD_CONFIG = $(HOSTAPD_D)/config_openssl

ifeq ($(BR2_PACKAGE_SDCSUPP_HOSTAPD),y)
define SDCSUPP_BUILD_HOSTAPD
	cp $(HOSTAPD_CONFIG) $(HOSTAPD_D)/.config
	$(MAKE) -C $(HOSTAPD_D) clean
	CFLAGS="-I$(STAGING_DIR)/usr/include/libnl3 $(TARGET_CFLAGS) -MMD -Wall -g" \
		$(SDCSUPP_MAKE_ENV) $(MAKE) -C $(HOSTAPD_D) V=1 CC="$(TARGET_CROSS)gcc" BINDIR=$(SDCSUPP_BINDIR)
endef
endif
...
ifeq ($(BR2_PACKAGE_SDCSUPP_HOSTAPD),y)
define SDCSUPP_INSTALL_HOSTAPD
	$(INSTALL) -D -m 755 $(HOSTAPD_D)/hostapd $(SDCSUPP_TARGET_DIR)$(SDCSUPP_BINDIR)/hostapd
endef

ifeq ($(BR2_PACKAGE_SDCSUPP_HOSTAPD_CLI),y)
define SDCSUPP_INSTALL_HOSTAPD_CLI
	$(INSTALL) -D -m 755 $(HOSTAPD_D)/hostapd_cli $(SDCSUPP_TARGET_DIR)$(SDCSUPP_BINDIR)/hostapd_cli
endef
endif
...
define SDCSUPP_INSTALL_TARGET_CMDS
	...
	$(SDCSUPP_INSTALL_SDCSUPP_SO)
	$(SDCSUPP_INSTALL_HOSTAPD)
	$(SDCSUPP_INSTALL_HOSTAPD_CLI)
endef
...
define SDCSUPP_UNINSTALL_TARGET_CMDS
	...
	rm -f $(SDCSUPP_TARGET_DIR)$(SDCSUPP_BINDIR)/hostapd
endef
