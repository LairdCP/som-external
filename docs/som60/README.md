...
```
~/git/lrd-7.x.y.z/wb$ cd buildroot/output/som60sd/images/
~/git/lrd-7.x.y.z/wb/buildroot/output/som60sd/images$ ls -al
at91-dvk_som60.dtb
...
Once your build completes, you will find the output similar to below:
```
~/git/lrd-7.x.y.z/wb$ cd buildroot/output/som60/images/
~/git/lrd-7.x.y.z/wb/buildroot/output/som60/images$ ls -al
at91-dvk_som60.dtb
boot.bin
boot.scr
...
```
~/git/lrd-7.x.y.z/wb/buildroot/output/som60sd$ make sdk
```
## NetworkManager
